...
btgpa1 = Button(win, text="Calculate TGPA", relief=RIDGE, bd=3, command=caltgpa1, state=ACTIVE,
                font=("Times New Roman", 11))
btgpa1.place(x=350, y=440)
...
btgpa2 = Button(win, text="Calculate TGPA", relief=RIDGE, bd=3, command=caltgpa2, state=ACTIVE,
                font=("Times New Roman", 11))
btgpa2.place(x=670, y=440)
...
def fill():
    ...
    if (
            s1s1grad1.get() == '' or s1s2grad2.get() == '' or s1s3grad3.get() == '' or s1s4grad4.get() == '' or s1s5grad5.get() == '' or s1s6grad6.get() == '' or s1s1cred1.get() == '0' or s1s2cred2.get() == '0' or s1s3cred3.get() == '0' or s1s4cred4.get() == '0' or s1s5cred5.get() == '0' or s1s6cred6.get() == '0'):
        f.insert(END, "\n  Please Fill in All details \n\tof Semester 1")
        f.place(x=50, y=200)

    if (
            s2s1grad1.get() == '' or s2s2grad2.get() == '' or s2s3grad3.get() == '' or s2s4grad4.get() == '' or s2s5grad5.get() == '' or s2s6grad6.get() == '' or s2s1cred1.get() == '0' or s2s2cred2.get() == '0' or s2s3cred3.get() == '0' or s2s4cred4.get() == '0' or s2s5cred5.get() == '0' or s2s6cred6.get() == '0'):
        f.insert(END, "\n  Please Fill in All details \n\tof Semester 2")
        f.place(x=50, y=200)

    if (
            s1s1grad1.get() != '' and s1s2grad2.get() != '' and s1s3grad3.get() != '' and s1s4grad4.get() != '' and s1s5grad5.get() != '' and s1s6grad6.get() != '' and s2s1grad1.get() != '' and s2s2grad2.get() != '' and s2s3grad3.get() != '' and s2s4grad4.get() != '' and s2s5grad5.get() != '' and s2s6grad6.get() != '' and s1s1cred1.get() != '0' and s1s2cred2.get() != '0' and s1s3cred3.get() != '0' and s1s4cred4.get() != '0' and s1s5cred5.get() != '0' and s1s6cred6.get() != '0' and s2s1cred1.get() != '0' and s2s2cred2.get() != '0' and s2s3cred3.get() != '0' and s2s4cred4.get() != '0' and s2s5cred5.get() != '0' and s2s6cred6.get() != '0'):
        f.insert(END, "\n  Successfully saved")
        f.place(x=50, y=200)
        f1 = open("save.txt", "a")
        f1.write("\n")
